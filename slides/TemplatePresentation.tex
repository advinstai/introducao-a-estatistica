...
\begin{itemize}
  \IteOne{Introdução}
  \IteOne{Conceitos}
  \IteOne{Processo de análise}
  \IteOne{Frequencia, tabela gráficos, histograma}
  \IteOne{Medidas de tendëncia}
  \IteOne{Medidas de variäncia}
  \IteOne{Correlação}
\end{itemize}
...
no pandas a quantidade de classes é definida por série usando o parâmetro bins do método value\_counts()
...
\begin{itemize}
\IteOne{ Investigar relação entre variáveis}
\IteOne{ Variáveis qualitativas}
\IteTwo{ tabelas de freqüência com dupla entrada. Essas tabelas de dados cruzados são conhecidas por tabelas de contingência  }
\IteOne{ Variáveis quantitativas}
\IteTwo{ Gráficos de Dispersão  }
\end{itemize}
...
Origem/grau de intrução & fundamental & médio & superior & total \\
Capital & 11 \% & 14 \% & 6 \% & 31 \% \\
Interior & 8 \% & 19 \% & 6 \% & 33 \% \\
Outra & 14 \% & 17 \% & 6 \% & 36 \% \\
Total: & 33 \% & 50 \% & 17 \% & 100 \% 
...
\end{center}
 ...
 \SliT{Introdução a Estatística}{
\begin{center}
\includegraphics[scale=0.70]{3434.png}     
\end{center}
}
